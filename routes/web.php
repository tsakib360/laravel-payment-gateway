...
Route::post('/payments/approval', [PaymentController::class, 'approval'])->name('approval.post');
Route::post('/payments/cancelled', [PaymentController::class, 'cancelled'])->name('cancelled.post');
